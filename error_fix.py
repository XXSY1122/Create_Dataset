...
n=1723 # 원하는 첫번째 파일명 (ex. 2476이면 2476.png / 2476.txt 이 시작파일)
...
#JAWSBAR
#p1=f'C:\\Users\\user\\Downloads\\nugabar\\NUGABAR2\\*.png'
p1=f'C:\\Users\\user\\Downloads\\movie3\\*.png'
p2=f'C:\\Users\\user\\Downloads\\movie3\\*.txt'
...
for i in range(len(img_list)):
    ...
    new_img_path=f"C:\\Users\\user\\Downloads\\train\\images\\{n}.png"
    new_label_path=f"C:\\Users\\user\\Downloads\\train\\labels\\{n}.txt"
